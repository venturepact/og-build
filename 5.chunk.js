...
var CouponsComponent = (function (_super) {
    ...
    function CouponsComponent(_adminService, _script, fb, _membershipService) {
        ...
        this.createCouponsForm = this.fb.group({
            ...
            extra_calc: ['1', __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_4__angular_forms__["e" /* Validators */].pattern('^[1-9][0-9]*$')])],
