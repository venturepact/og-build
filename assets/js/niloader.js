...
function initMobileFrames(iframe_id) {
    ...
    if (!document.getElementById("og_body_wrapper")) {
        ...
        if (IS_IPHONE) {
            var style_node = document.createTextNode("body, html {height: 100%;margin: 0;}.fullScreen {z-index:9990;width: 100%;height: 100% !important;position: fixed;top: 0;left: 0;}.hide{display:none;}.height-auto{height: 100vh;margin:0px}.ovr-hid{overflow: hidden !important;}")
        } else {
