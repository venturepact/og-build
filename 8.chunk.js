...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__templates_services_DefaultJSON_service__ = __webpack_require__(877);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_services_script_service__ = __webpack_require__(129);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__templates_component__ = __webpack_require__(1058);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__templates_services_DefaultJSON_service__ = __webpack_require__(877);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__toolbar_toolbar_module__ = __webpack_require__(422);
...
var TemplatesModule = (function () {
    ...
    TemplatesModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* NgModule */])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__shared_modules_shared_module__["a" /* SharedModule */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forChild(TEMPLATES_ROUTES), __WEBPACK_IMPORTED_MODULE_5__toolbar_toolbar_module__["a" /* ToolbarModule */]],
...
//# sourceMappingURL=/Applications/XAMPP/xamppfiles/htdocs/projects/Outgrow/migration/Outgrow-frontend/src/templates.module.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__builder_models_model__ = __webpack_require__(817);
...
var DefaultJSON = (function () {
    ...
    DefaultJSON.prototype.getONPSjson = function () {
        ...
        var item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('header', "<strong>CALCULATE THE RISK OF YOU GETTING A HEART DISEASE</strong>", 'textfield help', '', 'main-heading th-bold-new');
        var item2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('sub_header', "Heart problems are at an all time high. See if your lifestyle makes you susceptible.", 'textfield help', '', 'sub-heading ts-bold-new');
        ...
        //R1
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('result_output', '<p>{R1}</p>', "<p>By age of 30</p>\n        <p>It is not common to get a heart disease so early on in life. You'll be safe!</p>", '', '');
        ...
        section2.addItems(item1);
        //R2
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('result_output', '<p>{R2}</p>', "<p>By the age of 40</p>\n                        <p>You're at a higher risk, but don't worry - no need to panic.</p>\n                        ", '', '');
        item1.options[0].label = item1.props.title;
        item1.options[0].icon = item1.props.helpText;
        item1.options.push(item1.options[0]);
        ...
        section2.addItems(item1);
        //R3
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('result_output', '<p>{R3}</p>', "<p>By the age of 50</p>\n                        <p>The risks get higher, but a good diet will keep you safe.</p>\n                        ", '', '');
        item1.options[0].label = item1.props.title;
        item1.options[0].icon = item1.props.helpText;
        item1.options.push(item1.options[0]);
        Formulaindex = app.addformula();
        ...
        section2.addItems(item1);
        //R4
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('result_output', '<p>{R4}</p>', "<p>By the age of 65</p>\n                        <p>Things get serious now. Ensure you're living healthy.</p>", '', '');
        item1.options[0].label = item1.props.title;
        item1.options[0].icon = item1.props.helpText;
        item1.options.push(item1.options[0]);
        Formulaindex = app.addformula();
        ...
        item3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('result_disclaimer', "The prices suggested are rough estimates and are not guaranteed.", '', '', 'bottom-section');
        //label is title , icon is description
        item4 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('cta_shares');
        ...
        //label is for Url
        var item5 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('cta_likes');
    ...
    DefaultJSON.prototype.getONPSRecommendedjson = function () {
        var app = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["a" /* App */]('Recommendation'); //create new app
        app.setThemeColor('cp1');
        //create pages
        var landingPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Landing', 'https://cdn.filestackcontent.com/0sHxFZL9T9qyI3Vf6jcO');
        var questionPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Questionnaire');
        var resultPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Result', 'https://cdn.filestackcontent.com/0sHxFZL9T9qyI3Vf6jcO');
        //add All pages in app
        app.addPages(landingPage, questionPage, resultPage);
        // LANDING Page starts //
        // section 1 of LANDING page
        var section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Logo Heading', 't1-landing-top');
        var item0 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('logo', 'https://cdn.filepicker.io/api/file/NIqLhmqRRWy4WH70ycfi', 'textfield help', '', 't1-logo');
        section1.addItems(item0);
        // section 2 of LANDING page
        var section2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Content Area', 'landing-page-mid');
        var item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('header', "<strong>Where to build your Startup?</strong>", 'textfield help', '', 'main-heading th-bold-new');
        var item2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('sub_header', "See which emerging tech hub you should head to!", 'textfield help', '', 'sub-heading ts-bold-new');
        item2.setVisibility(true);
        var item3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('leadform', 'Let’s Find Out', 'textfield help', '', 't1-landing-leadform');
        item3.setVisibility(false);
        var item4 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('click_button', 'Let’s Find Out', 'textfield help', '', 't1-button');
        item4.setVisibility(true);
        section2.addItems(item1, item2, item3, item4);
        // section 3 of LANDING page
        var section3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Footer', 'landing-footer-outer');
        ...
        //Result Section 2 -- End
        section3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('LeadForm', 'left-section');
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('leadform', 'Learn More', '', '', 'cta-outer');
        item1.setVisibility(false);
        item2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('click_button', 'Learn More', 'textfield help', '', 't1-result-cta');
        item2.setVisibility(true);
        item3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('result_disclaimer', "The prices suggested are rough estimates and are not guaranteed.", '', '', 'bottom-section');
        item3.setVisibility(false);
        //label is title , icon is description
        ...
        item4.setVisibility(false);
        //label is for Url
        item5 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('cta_likes');
        item5.addOptions([{ type: 'Facebook', selected: true, label: 'http://www.facebook.com/outgrowco' },
            { type: 'Twitter', selected: false, label: 'outgrowco' }]);
        item5.setVisibility(false);
        section3.addItems(item1, item2, item3, item4, item5);
        ...
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('result_summary');
        section5.addItems(item1);
        var section6 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Powered By');
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('poweredby', 'This is powered by', 'poweredby help');
    ...
    DefaultJSON.prototype.getOPCjson = function () {
        ...
        // section 1 of LANDING page
        var section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Logo Heading', 't1-landing-top');
        var item0 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('logo', 'https://cdn.filestackcontent.com/RycvxkK6QgSX2OAVqPm6', 'textfield help', '', 't1-logo');
        // let item0 = new Item('Item', '../../+builder/assets/template1-logo.png', 'textfield help');
        section1.addItems(item0);
        // section 2 of LANDING page
        var section2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Content Area', 'landing-page-mid');
        var item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('header', "<strong>How much should you pay for a video campaign?</strong>", 'textfield help', '', 'main-heading th-bold-new');
        var item2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('sub_header', "Video campaigns can be expensive and many agencies will take you for a ride. See how much you should actually be paying!", 'textfield help', '', 'sub-heading ts-bold-new');
        item2.setVisibility(false);
        var item3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('leadform', 'Get Started', 'textfield help', '', 't1-landing-leadform');
        item3.setVisibility(false);
        var item4 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('click_button', 'Get Started', 'textfield help', '', 't1-button');
        item4.setVisibility(true);
        section2.addItems(item1, item2, item3, item4);
        // section 3 of LANDING page
        var section3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Footer', 'landing-footer-outer');
        ...
        // Questionnaire page starts //
        //leadform section
        var leadSection = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('LeadFormQ', 't1-question-mid', 'Where can we send you a detailed report?');
        leadSection.setVisibility(true);
        leadSection.setVisibilityOfShowDesc(false);
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('leadform_question', 'Next', '', '', '');
        item1.setVisibility(true);
        ...
        questionPage.addSections(leadSection);
        // SUB Section1(Questions) of Question Page
        section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Production Requirements', 't1-question-mid', 'Tell us a little bit more!');
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('slider', 'How many actors do you need in your video?', 'Please add the help text', undefined, undefined, 1, 20);
        item2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('slider', 'How many locations do you need to shoot at?', 'Please add the help text', undefined, undefined, 1, 10);
        item3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('checkbox', 'Where are you going to publish this video?', 'Please add the help text');
        item3.addFieldToCheckbox([{ label: 'Web', icon: '' },
            { label: 'TV', icon: '' }]);
        item4 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('radio_button', 'What do you expect the length of the video to be?', 'Please add the help text', '');
        ...
        var item5 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('radio_button', 'What sort of a setting are you considering?', 'Please add the help text');
        item5.addFieldToCheckbox([{ label: 'Indoor', icon: '' },
            { label: 'Outdoor', icon: '' }]);
        var item6 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('textfield', 'Where can we find your brand assets for reference?', 'Please add the help text', ' http://www.example.com  ');
        section1.addItems(item1, item2, item3, item4, item5, item6);
        questionPage.addSections(section1);
        //--- Result page sections --- START
        section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Header', 'top-head');
        ...
        section2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Result', 'left-section');
        //R1
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('result_output', '<p><strong>{R1}</strong></p>', "<p><strong>For top notch HDTV quality</strong></p>\n                       <p>Using the same camera and crew that shot Gravity and Avtar!</p>", '', 't3-default-result-outer tr-bold-new');
        item1.options[0].label = item1.props.title;
        item1.options[0].icon = item1.props.helpText;
        item1.options.push(item1.options[0]);
        var Formulaindex = app.addformula();
    ...
    DefaultJSON.prototype.getITjson = function () {
        ...
        app.setThemeColor('cp1');
        //create pages
        var landingPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Landing', 'https://cdn.filestackcontent.com/Cvj2tN3S7ikTu981vJVp');
        var questionPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Questionnaire');
        var resultPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Result');
        //add All pages in app
        app.addPages(landingPage, questionPage, resultPage);
        ...
        // section 1 of LANDING page
        var section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Logo Heading', 't1-landing-top');
        var item0 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('logo', 'https://cdn.filestackcontent.com/RIPfc1fwR4H51kqKtSRg', 'textfield help', '', 't1-logo');
        // let item0 = new Item('Item', '../../+builder/assets/template1-logo.png', 'textfield help');
        section1.addItems(item0);
        // section 2 of LANDING page
        var section2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Content Area', 'landing-page-mid');
        ...
        // SUB Section1(Questions) of Question Page
        section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Production Requirements', 't1-question-mid', 'Tell us a little bit more!');
        item1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('selectbox', 'I need', 'Default Help Text', ' 3', '', 0, 0, 'actors in my video.');
        ...
        item2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('selectbox', 'I want to shoot at', 'Default Help Text', ' 2  ', '', 0, 0, 'locations.');
        item2.addFieldToCheckbox([{ label: '1', icon: '', value: '' },
            { label: '2', icon: '', value: '' }, { label: '3', icon: '', value: '' },
            { label: '4', icon: '', value: '' }, { label: '>5', icon: '', value: '' }]);
        item3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('selectbox', 'This video will get published on', 'Default Help Text', 'Media', '', 0, 0, '.');
        ...
        item4 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('selectbox', 'I expect the length of the video to be', 'Default Help Text', ' < 1 minute ', '', 0, 0, '.');
        ...
        var item5 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('selectbox', 'It is going to be a', 'Default Help Text', ' type  ', '', 0, 0, 'setting.');
        item5.addFieldToCheckbox([{ label: 'Indoor', icon: '', value: '' },
            { label: 'Outdoor', icon: '', value: '' }]);
        var item6 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('textfield', 'You can we find our brand assets at', 'Please add the help text', ' example.com  ');
        section1.addItems(item1, item2, item3, item4, item5, item6);
        questionPage.addSections(section1);
        //--- Result page sections --- START
        section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Header', 'top-head');
    ...
    DefaultJSON.prototype.getITRecommendedjson = function () {
        ...
        var landingPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Landing', 'https://cdn.filestackcontent.com/Cvj2tN3S7ikTu981vJVp');
        var questionPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Questionnaire');
        var resultPage = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["b" /* Page */]('Result', 'https://cdn.filestackcontent.com/Cvj2tN3S7ikTu981vJVp');
        //add All pages in app
        app.addPages(landingPage, questionPage, resultPage);
        // LANDING Page starts //
        // section 1 of LANDING page
    ...
    DefaultJSON.prototype.getSCjson = function () {
        ...
        // section 1 of LANDING page
        var section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Logo Heading', 't1-landing-top');
        var item0 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('logo', 'https://cdn.filepicker.io/api/file/zkSrHlXZQVyIJYG3HVBq', 'textfield help', '', 't1-logo');
        // let item0 = new Item('Item', '../../+builder/assets/template1-logo.png', 'textfield help');
        section1.addItems(item0);
        // section 2 of LANDING page
        var section2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Content Area', 'landing-page-mid');
        ...
        var item2 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('sub_header', "Video campaigns can be expensive and many agencies will take you for a ride. See how much you should actually be paying!", 'textfield help', '', 'sub-heading ts-bold-new');
        item2.setVisibility(false);
        var item3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('leadform', 'Estimate Costs', 'textfield help', '', 't1-landing-leadform');
        item3.setVisibility(true);
        var item4 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('click_button', 'Estimate Costs', 'textfield help', '', 't1-button');
        item4.setVisibility(false);
        section2.addItems(item1, item2, item3, item4);
        // section 3 of LANDING page
        var section3 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Footer', 'landing-footer-outer');
        ...
        item5.addFieldToCheckbox([{ label: 'Indoor', icon: '' },
            { label: 'Outdoor', icon: '' }]);
        var item6 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["d" /* Item */]('textfield', 'Where can we find your brand assets for reference?', '', 'http://www.example.com');
        section1.addItems(item1, item2, item3, item4, item5, item6);
        questionPage.addSections(section1);
        //--- Result page sections --- START
        section1 = new __WEBPACK_IMPORTED_MODULE_1__builder_models_model__["c" /* Section */]('Header', 'top-head');
...
//# sourceMappingURL=/Applications/XAMPP/xamppfiles/htdocs/projects/Outgrow/migration/Outgrow-frontend/src/DefaultJSON.service.js.map
