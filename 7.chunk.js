...
var TrafficDetailsComponent = (function () {
    ...
    TrafficDetailsComponent.prototype.getStats = function () {
        var _this = this;
        //geo location data
        setTimeout(function () { return _this.subs.push(_this.getGeoStats()); }, 100);
        //device data
        setTimeout(function () { return _this.subs.push(_this.getDeviceStats()); }, 200);
        //social data
        setTimeout(function () { return _this.subs.push(_this.getSocialStats()); }, 300);
        //browser data
        setTimeout(function () { return _this.subs.push(_this.getBrowserStats()); }, 400);
    };
