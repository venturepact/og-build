...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__analytics_component__ = __webpack_require__(1016);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_modules_shared_module__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_modules_utilities_module__ = __webpack_require__(885);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__analyticsChild_module__ = __webpack_require__(901);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_calculator_analytics_service__ = __webpack_require__(804);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_overview_overview_component__ = __webpack_require__(902);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_user_details_user_details_component__ = __webpack_require__(904);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_traffic_details_traffic_details_component__ = __webpack_require__(903);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_user_details_popup_user_details_popup_component__ = __webpack_require__(905);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_modules_shared_module__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_modules_utilities_module__ = __webpack_require__(885);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_calculator_analytics_service__ = __webpack_require__(804);
...
var UserDetailsComponent = (function () {
    ...
    UserDetailsComponent.prototype.avgAnalyticsData = function (data) {
        ...
        if (data.length) {
            data.map(function (response) {
                if (response[3] != '--' || response[4] != '--' || response[5] != '--' || response[6] != '--') {
                    //avg time
                    _this.totalTime += Number(response[5]);
                    var avgTime = _this.totalTime / response.length;
                    _this.avgLengthTime = (avgTime > 60) ? (avgTime / 60).toFixed(2) + ' m' : avgTime.toFixed(2) + ' s';
                    _this.viewedOnStats[response[3]] += 1;
                    _this.viewedViaStats[response[6] == '(not set)' ? 'direct' : response[6]] += 1;
    ...
    UserDetailsComponent.prototype.intializeDatatable = function () {
        ...
        this.dataTableRef = jQuery('#myTable').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                "url": "http://localhost:3000/api/v1/analytic/get_leads",
                "type": "POST",
        ...
        this.dataTableRef.column(3).visible(false);
    };
